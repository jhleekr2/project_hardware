...
public class BoardServiceImpl implements BoardService{
    ...
    public void boardModify(BoardWithFile boardWithFile) {
        ...
        List<String> uploadimglist = boardWithFile.getUploadfile();
        List<String> uploadgenerallist = boardWithFile.getUploadgeneralfile();

        // 이때 업로드 파일을 넣을 게시글 번호도 같이 넘겨야 한다.
        fileService.validateimgDB(boardNo, uploadimglist);
        fileService.validatefileDB(boardNo, uploadgenerallist);
