    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(authz->authz.requestMatchers("/", "/loginPage", "/logout", "/registerPage", "/bbs/board", "/bbs/view/**", "/img/**", "/download/**")
                        ...
                        .requestMatchers("/api/v1/board", "/api/v1/boardView/**", "/api/v1/delete/**", "/api/v1e/board", "/ap1/v1/rollback", "/api/v1/boardFileView/**", "/api/v1/comment/view/**").permitAll()
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/write", "/api/v1/uploadimg", "/api/v1/uploadfile", "/api/v1/comment/write/**").hasAnyAuthority("ADMIN", "MANAGER", "MEMBER")
